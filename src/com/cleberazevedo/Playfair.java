...
public class Playfair {
    ...
    public static void main(String[] args) {
        ...
        String txt = prompt("Entre com a Mensagem: ", sc, 1);

        createTable(key);

        String enc = encode(prepareText(txt));

        System.out.printf("%nMensagem Criptografada: %n%s%n", enc);
        System.out.printf("%nMensagem Decriptografada: %n%s%n", decode(enc));
    }
